 ...
 * @version      $0.1 $
 */
function Book_subscribeblock_init()
{
    // Security
    pnSecAddSchema('subscibeblock:', 'Block title::');
}
 ...
 */
function Book_subscribeblock_info()
{
 ...
 */
function Book_subscribeblock_display($blockinfo)
{
    ...
    $custom = $username;
    $pnRender->assign('custom', $custom);
    $pnRender->assign('uid', $uid);
    // Populate block info and pass to theme
    $blockinfo['content'] = $pnRender->fetch('book_block_subscribe.htm');
 ...
 */
function Book_subscribeblock_update($blockinfo)
{
    // Get current content
    $vars = pnBlockVarsFromContent($blockinfo['content']);
