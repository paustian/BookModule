...
function _url_replace_func($matches) {
...
function book_admin_newbook() {
    ...
    return $pnRender->fetch('book_admin_newbook.htm');
}

/**
 * add new chapter to a book
 */
function book_admin_newchapter() {
    if (!SecurityUtil::checkPermission('Book::', "::", ACCESS_ADD)) {
        return LogUtil::registerPermissionError();
    }
    ...
    if ($bookItems == 0) {
        ...
        return LogUtil::registerError(__("You have to create a book before you can create a chapter or an article"));
    }
    ...
    $pnRender->assign('bookmenu', $menu);

    return $pnRender->fetch('book_admin_newchapter.htm');
}
 ...
 */
function book_admin_newarticle() {
    if (!SecurityUtil::checkPermission('Book::', "::", ACCESS_ADD)) {
        return LogUtil::registerPermissionError();
    }
    ...
    foreach ($books as $book_item) {
        ...
        $chap_info = pnModAPIFunc('Book', 'user',
                        'getallchapters',
    ...
    if (!count($chap_menus)) {
        return LogUtil::registerError(__('You have to create a Chapter before you can create an an article'));
    }
    ...
    $pnRender->assign('chapters', $chap_menus);

//create the language list
    $pnRender->assign('language', 'eng');


    // Return the output that has been generated by this function
    return $pnRender->fetch('book_admin_newarticle.htm');
}
...
function book_admin_newfigure() {
    ...
    $pnRender->assign('books', $bookMenu);
    ...
    return $pnRender->fetch('book_admin_newfigure.htm');
}
 ...
 * for any book.
 */
function book_admin_newglossary() {
    ...
    // Return the output that has been generated by this function
    return $pnRender->fetch('book_admin_newglossary.htm');
}
 ...
 */
function book_admin_create($args) {
    // Security check
    if (!SecurityUtil::checkPermission('Book::', "::", ACCESS_ADD)) {
        return LogUtil::registerPermissionError();
    }
    ...
    $tid = pnModAPIFunc('Book', 'admin', 'create', array('book_name' => $name));

    if ($tid != false) {
        // Success
        SessionUtil::setVar('statusmsg', __('Book item created'));
    }
 ...
 */
function book_admin_createchapter($args) {
    // Security check
    if (!SecurityUtil::checkPermission('Book::', "::", ACCESS_ADD)) {
        return LogUtil::registerPermissionError();
    }
    ...
    $chap_id = pnModAPIFunc('Book',
                    'admin',
                    'createchapter',
                    array('chap_name' => $name,
                        'chap_number' => $number,
                        'book_id' => $book));
 ...
 */
function book_admin_createarticle($args) {
    // Security check
    if (!SecurityUtil::checkPermission('Book::', "::", ACCESS_ADD)) {
        return LogUtil::registerPermissionError();
    }
    ...
    if ($article_id != false) {
        // Success
        SessionUtil::setVar('statusmsg', __('An article was created'));
    }
 ...
 */
function book_admin_createfigure($args) {
    // Security check
    if (!SecurityUtil::checkPermission('Book::', "::", ACCESS_ADD)) {
        return LogUtil::registerPermissionError();
    }
    ...
    if ($fig_id != false) {
        // Success
        SessionUtil::setVar('statusmsg', __('Figure was created.'));
    }
 ...
 */
function book_admin_createglossary($args) {
    if (!SecurityUtil::checkPermission('Book::', "::", ACCESS_ADD)) {
        return LogUtil::registerPermissionError();
    }
    // Get parameters from whatever input we need.
    ...
    if ($gloss_id != false) {
        // Success
        SessionUtil::setVar('statusmsg', __('Glossary item created'));
    }
...
function book_admin_modify() {
    ...
    if ($items == false) {
        return LogUtil::registerError(__('There are no books to get'));
    }
    ...
    $pnRender->assign('books', $items);


    // Return the output that has been generated by this function
    return $pnRender->fetch('book_admin_modify.htm');
}
 ...
 */
function book_admin_update($args) {
    if (!SecurityUtil::checkPermission('Book::', "::", ACCESS_EDIT)) {
        return LogUtil::registerPermissionError();
    }
    // Get parameters from whatever input we need.
    ...
    if (pnModAPIFunc('Book',
                    ...
                    array('book_id' => $book_id,
                        'book_name' => $book_name))) {
        // Success
        SessionUtil::setVar('statusmsg', __('The book was updated.'));
    }
 ...
 *
 */
function book_admin_modifychapter() {
    if (!SecurityUtil::checkPermission('Book::', "::", ACCESS_EDIT)) {
        return LogUtil::registerPermissionError();
    }
    ...
    $pnRender->assign('books', $books);
    $pnRender->assign('chaps', $chapters);

    // Return the output that has been generated by this function
    return $pnRender->fetch('book_admin_modifychapter.htm');
}
 ...
 *
 */
function book_admin_updatechapter($args) {
    // Get parameters from whatever input we need.
    //This is the radio button that is active
    //it will be a number
    ...
    if (pnModAPIFunc('Book',
        ...
        LogUtil::registerError(__('Update of chapter failed.'));
        return false;
    }
 ...
 *
 */
function book_admin_modifyarticle1() {
    if (!SecurityUtil::checkPermission('Book::', "::", ACCESS_EDIT)) {
        return LogUtil::registerPermissionError();
    }
    ...
    $book_string = make_list();
    $pnRender->assign('books', $book_string);

    return $pnRender->fetch('book_admin_modifyarticle1.htm');
}

function make_list($isForm=true, $access_level=ACCESS_EDIT) {
    $books = pnModAPIFunc('Book',
                    'user',
                    'getall');
    ...
    foreach ($books as $book_item) {
        ...
        $book_chapters = pnModAPIFunc('Book',
                        'user',
                        'getallchapters',
                        array('book_id' => $book_item['book_id']));
        //add the book name
        ...
        foreach ($book_chapters as $chap_item) {
            ...
            if (SecurityUtil::checkPermission('Book::Chapter', "$book_item[book_id]::$chap_item[chap_id]", $access_level)) {
                ...
                $articles = pnModAPIFunc('Book',
                                'user',
                                'getallarticles',
                                array('chap_id' => $chap_item['chap_id'],
                                    'book_id' => $book_item['book_id'],
                                    'get_content' => false));
    ...
    if ($have_articles == false) {
        return LogUtil::registerError(__('There was no articles to edit.'));
    }
    return $book_string;
}
 ...
 *
 */
function book_admin_modifyarticle2() {
    if (!SecurityUtil::checkPermission('Book::', "::", ACCESS_EDIT)) {
        return LogUtil::registerPermissionError();
    }
...
// Confirm authorisation code.
    ...
    $book = pnModAPIFunc('Book',
                    'user',
                    'get',
                    array('book_id' => $article['book_id']));


    $chapters = pnModAPIFunc('Book',
                    'user',
                    'getallchapters',
                    array('all_chapters' => true));
    //This solves a problem where entities for editing were getting translated.
    //This is not working!
    //This will no longer happen
    $contents = preg_replace_callback('/href="(.*?)"/', '_url_replace_func', $article['contents']);
    //we need all of this
    $pnRender->assign('contents', $contents);
    ...
    $pnRender->assign('art_number', $article['art_number']);
    ...
    $pnRender->assign('chap_menu', $chap_menu);
    $pnRender->assign('selected_chapter', $article['chap_id']);
    $pnRender->assign('language', 'English');
    ...
    return $pnRender->fetch('book_admin_modifyarticle2.htm');
}
 ...
 *
 */
function book_admin_updatearticle($args) {
    if (!SecurityUtil::checkPermission('Book::', "::", ACCESS_EDIT)) {
        return LogUtil::registerPermissionError();
    }
    // Confirm authorisation code.
    ...
    // Call apiupdate to do all the work
    if (pnModAPIFunc('Book', 'admin', 'updatearticle', array('art_id' => $art_id, 'book_id' => $book_id,
                'title' => $title,
                'contents' => $content,
                'chap_id' => $chap_id,
                'lang' => $lang,
                ...
                'art_number' => $art_number))) {
        // Success
        SessionUtil::setVar('statusmsg', __('Article updated.'));
    } else {
        LogUtil::registerError(__('Update of article failed.'));
        return false;
    }
...
function book_admin_modifyfigure1() {
    if (!SecurityUtil::checkPermission('Book::', "::", ACCESS_EDIT)) {
        return LogUtil::registerPermissionError();
    }
    ...
    // The user API function is called
    $figData = pnModAPIFunc('Book',
                    'user',
                    'getallfigures');


    if ($figData == false) {
        return LogUtil::registerError(__('There are no figures to edit'));
    }
    ...
    $pnRender->assign('fig_list', $fig_menu);
    ...
    $pnRender->assign('book_menu', $book_menu);

    // Return the output that has been generated by this function
    return $pnRender->fetch('book_admin_modifyfigure1.htm');
}

function book_admin_modifyfigure2() {
    ...
    if ($figure == false) {
        return LogUtil::registerError(__('There are no articles to edit.'));
    }

    //we need all of this
    $pnRender->assign('fig_content', $figure['fig_content']);
    $pnRender->assign('fig_title', $figure['fig_title']);
    $pnRender->assign('fig_number', $figure['fig_number']);
    $pnRender->assign('img_link', $figure['img_link']);
    $pnRender->assign('fig_id', $figure['fig_id']);
    $pnRender->assign('fig_perm', $figure['fig_perm']);
    $pnRender->assign('chap_number', $figure['chap_number']);
    $pnRender->assign('book_id', $figure['book_id']);
    ...
    return $pnRender->fetch('book_admin_modifyfigure2.htm');
}
 ...
 *
 */
function book_admin_updatefigure($args) {
    if (!SecurityUtil::checkPermission('Book::', "::", ACCESS_EDIT)) {
        return LogUtil::registerPermissionError();
    }
// Confirm authorisation code.
    ...
    if ($result) {
        // Success
        SessionUtil::setVar('statusmsg', __('The figure was updated.'));
    } else {
        LogUtil::registerError(__('Update of figure failed.'));
        return false;
    }
 ...
 *
 */
function book_admin_modifyglossary1() {
    // Create output object
    $pnRender = pnRender::getInstance('Book', false);
    ...
    // The user API function is called
    $glossary_terms = pnModAPIFunc('Book',
                    'user',
                    'getallglossary');

    if ($glossary_terms == false) {
        return LogUtil::registerError(__('There are no glossary terms to edit.'));
    }
    ...
    $pnRender->assign('term1', $term1);
    $pnRender->assign('term2', $term2);
    $pnRender->assign('term3', $term3);
    $pnRender->assign('term4', $term4);
    $pnRender->assign('last1', $last1);
    $pnRender->assign('last2', $last2);
    $pnRender->assign('last3', $last3);

    // Return the output that has been generated by this function
    return $pnRender->fetch('book_admin_modifyglossary1.htm');
}
 ...
 *
 */
function book_admin_modifyglossary2($args) {
    // Security check
    if (!SecurityUtil::checkPermission('Book::', "::", ACCESS_EDIT)) {
        return LogUtil::registerPermissionError();
    }
    ...
    // The user API function is called
    $glossData = pnModAPIFunc('Book',
                    'user',
                    'getglossary',
                    array('gloss_id' => $gloss_id));
    //print_r($glossData);die;
    $pnRender->assign('glossary', $glossData);

    // Return the output that has been generated by this function
    return $pnRender->fetch('book_admin_modifyglossary2.htm');
}

function book_admin_updateglossary($args) {
    if (!SecurityUtil::checkPermission('Book::', "::", ACCESS_EDIT)) {
        return LogUtil::registerPermissionError();
    }
    if (!SecurityUtil::confirmAuthKey()) {
    ...
    if (pnModAPIFunc('Book',
                    ...
                    array('gloss_id' => $gloss_id,
                        ...
                        'definition' => $definition))) {
        // Success
        SessionUtil::setVar('statusmsg', __('The glossary has been updated.'));
    } else {
        LogUtil::registerError(__('Update of glossary failed.'));
        return false;
    }
...
function book_admin_dodelete() {
    ...
    if ($bookItems == 0) {
        //if we dont' have a book, then you
        //cannot delete it
        return LogUtil::registerError(__('There is not book to edit.'));
    }

    $pnRender->assign('books', $bookItems);

    return $pnRender->fetch('book_admin_dodelete.htm');
}
 ...
 *
 */
function book_admin_delete($args) {
    if (!SecurityUtil::checkPermission('Book::', "::", ACCESS_DELETE)) {
        return LogUtil::registerPermissionError();
    }
    if (!SecurityUtil::confirmAuthKey()) {
    ...
    // The API function is called.
    $tid = pnModAPIFunc('Book',
                    'admin',
                    'delete',
                    array('book_id' => $book_id));
    if ($tid != false) {
        // Success
        SessionUtil::setVar('statusmsg', __('The book was deleted.'));
    }
 ...
 */
function book_admin_chapterdisplay($args) {
    // Create output object - this object will store all of our output so that
    // we can return it easily when required
    $pnRender = pnRender::getInstance('Book', false);
    ...
    $chap_menus = _generate_chapter_menu($pnRender);
    //print_r($chap_menus);die;
    $pnRender->assign('chapters', $chap_menus);

    return $pnRender->fetch('book_admin_dochapterdelete.htm');
}

function _generate_chapter_menu($pnRender) {
    //get the complete list of books
    $books = pnModAPIFunc('Book',
                    'user',
                    'getall',
...
function book_admin_do_export($args) {
    ...
    if ($books == false) {
        //if we dont' have a book, then you
        //cannot have chapters
        return LogUtil::registerError(__('There are no books to export'), null, $ret_url);
    }
    ...
    if ($j == $i) {
        return LogUtil::registerError(__('There are no chapters to export.'), null, $ret_url);
    }
    ...
    return $pnRender->fetch('book_admin_doexport.htm');
}
 ...
 *
 */
function book_admin_deletechapter($args) {
    if (!SecurityUtil::checkPermission('Book::', "::", ACCESS_DELETE)) {
        return LogUtil::registerPermissionError();
    }
    if (!SecurityUtil::confirmAuthKey()) {
    ...
    $tid = pnModAPIFunc('Book',
                    'admin',
                    'deletechapter',
                    array('chap_id' => $chap_id));
    if ($tid != false) {
        // Success
        SessionUtil::setVar('statusmsg', __('Chapter(s) deleted'));
    }
 ...
 * this one.
 */
function book_admin_dodeletearticle() {
    if (!SecurityUtil::checkPermission('Book::', "::", ACCESS_DELETE)) {
        return LogUtil::registerPermissionError();
    }
    $pnRender = pnRender::getInstance('Book', false);
    ...
    return $pnRender->fetch('book_admin_doarticledelete.htm');
}
 ...
 */
function book_admin_deletearticle($args) {
    if (!SecurityUtil::checkPermission('Book::', "::", ACCESS_DELETE)) {
        return LogUtil::registerPermissionError();
    }
    if (!SecurityUtil::confirmAuthKey()) {
    ...
    if ($tid != false) {
        // Success
        SessionUtil::setVar('statusmsg', __('Article(s) deleted.'));
    }
 ...
 */
function book_admin_dodeletefigure() {
    // Create output object
    $pnRender = pnRender::getInstance('Book', false);
    ...
    if ($figData == false) {
        ...
        return LogUtil::registerError(__('There are no figures to delete.'));
    }
    ...
    // Return the output that has been generated by this function
    return $pnRender->fetch('book_admin_deletefigure.htm');
}

function book_admin_deletefigure($args) {
    if (!SecurityUtil::checkPermission('Book::', "::", ACCESS_DELETE)) {
        return LogUtil::registerPermissionError();
    }
    if (!SecurityUtil::confirmAuthKey()) {
    ...
    if (pnModAPIFunc('Book',
                    ...
                    array('fig_id' => $fig_id))) {
        // Success
        SessionUtil::setVar('statusmsg', __('Book figure deleted.'));
    }
...
function book_admin_dodeleteglossary() {
    // Create output object
    $pnRender = pnRender::getInstance('Book', false);
    ...
    if ($glossary_terms == false) {
        return LogUtil::registerError(__('There are no glossary terms to delete.'));
    }
    ...
    // Return the output that has been generated by this function
    return $pnRender->fetch('book_admin_dodeleteglossary.htm');
}

function book_admin_deleteglossary($args) {
    if (!SecurityUtil::checkPermission('Book::', "::", ACCESS_DELETE)) {
        return LogUtil::registerPermissionError();
    }
    //get the glossary id.
    ...
    if (pnModAPIFunc('Book',
                    ...
                    array('gloss_id' => $gloss_id))) {
        // Success
        SessionUtil::setVar('statusmsg', __('Glossary item(s) deleted.'));
    }
 ...
 */
function book_admin_addglossaryitems($args) {
    $pnRender = pnRender::getInstance('Book', false);
    ...
    pnModAPIFunc('Book', 'admin', 'addglossaryitems', array('art_id' => $art_id));
 ...
 * view items
 */
function book_admin_view() {
    //just return the main view.
    return book_admin_main();
}
 ...
 */
function book_admin_modifyconfig() {
    ...
    if (pnModGetVar('Book', 'securebooks')) {
        $pnRender->assign('issecure', "checked");
    } else {
        $pnRender->assign('issecure', '');
    }
    return $pnRender->fetch('book_admin_modifyconfig.htm');
}
 ...
 */
function book_admin_updateconfig() {
    return true;
}
...
function book_admin_menu() {
    ...
    $pnRender = pnRender::getInstance('Book', false);
    // Start options menu
    $pnRender->assign('title', __('The Book Module'));
 ...
 */
function book_admin_modifyaccess() {
    // Security check
    if (!SecurityUtil::checkPermission('Book::', "::", ACCESS_ADMIN)) {
        return LogUtil::registerPermissionError();
    }
    $secure = FormUtil::getPassedValue('secure', isset($args['secure']) ? $args['secure'] : null);
    pnModSetVar('Book', 'securebooks', $secure == "makesecure");
 ...
 */
function book_admin_export($args) {
    if (!SecurityUtil::checkPermission('Book::', "::", ACCESS_EDIT)) {
        return LogUtil::registerPermissionError();
    }
    if (!SecurityUtil::confirmAuthKey()) {
    ...
    if ($inline_figures == 'on') {
        ...
        $text = pnModFunc('Book', 'admin', 'exportchapter', array('chap_id' => $chap_id));
    }
    ...
    $text = preg_replace_callback('|href="(.*?)"|', "_url_replace_func", $text);

    $book = pnModAPIFunc('Book',
                    'user',
                    'get',
                    array('book_id' => $book_id));
    $pnRender->assign('export_text', $text);
    $pnRender->assign('book_name', $book['book_name']);
    $text = $pnRender->fetch('book_admin_export.htm');
    return $text;
}

function book_admin_exportchapter($args) {
    if (!SecurityUtil::checkPermission('Book::', "::", ACCESS_EDIT)) {
        return LogUtil::registerPermissionError();
    }
    ...
    $pnRender->assign('articles', $articles);

    $return_text = $pnRender->fetch('book_admin_chapter_xml.htm');
    ...
    /* $pattern = '/<a class="glossary" href.*?\'\)">(.*?)<\/a>/';
      ...
      $return_text = preg_replace($pattern, $replacement, $return_text); */
    $pnRender->assign('export_text', $return_text);
    return $return_text;
}
 ...
 */
function book_admin_exportbook($args) {
    if (!SecurityUtil::confirmAuthKey()) {
        return LogUtil::registerAuthidError(pnModURL('Book', 'admin', 'view'));
    }
    ...
    $pnRender->assign('export_text', $export_text);
    $pnRender->assign('book_name', $book['book_name']);
    return $pnRender->fetch('book_admin_export.htm');
}
 ...
 * be added to.
 */
function book_admin_doimport() {
    $pnRender = pnRender::getInstance('Book', false);
    // Security check
    if (!SecurityUtil::checkPermission('Book::', "::", ACCESS_EDIT)) {
        return LogUtil::registerPermissionError();
    }
    return $pnRender->fetch('book_admin_import.htm');
}
 ...
 */
function book_admin_import($args) {
    if (!SecurityUtil::checkPermission('Book::', "::", ACCESS_EDIT)) {
        return LogUtil::registerPermissionError();
    }
    ...
    if (!pnModAPIFunc('Book', 'admin', 'update', array('book_id' => $book_id, 'book_name' => $book_name))) {
        //if update fails, try create
        if (!pnModAPIFunc('Book', 'admin', 'create', array('book_id' => $book_id, 'book_name' => $book_name))) {
            //set an error message and return false
            SessionUtil::setVar('error_msg', __('Book import failed. Ha ha.'));
        }
    }
    $chap_matches = array();
    ...
    foreach ($chap_matches[1] as $chap_data) {
        ...
        if (!pnModAPIFunc('Book', 'admin', 'updatechapter', array('book_id' => $book_id, 'chap_name' => $chap_title, 'chap_number' => $chap_number, 'chap_id' => $chap_id))) {
            //if update fails, try create
            if (!pnModAPIFunc('Book', 'admin', 'createchapter', array('book_id' => $book_id, 'chap_name' => $chap_title, 'chap_number' => $chap_number, 'chap_id' => $chap_id))) {
                //set an error message and return false
                SessionUtil::setVar('error_msg', __('Chapter update failed. Ha ha.'));
            }
        }
        ...
        foreach ($matches[1] as $match_item) {
            ...
            if (!pnModAPIFunc('Book', 'admin', 'updatearticle',
                            array('art_id' => $art_id,
                                'book_id' => $book_id,
                                'title' => $art_title,
                ...
                if (!pnModAPIFunc('Book', 'admin', 'createarticle', array('art_id' => $art_id, 'book_id' => $book_id, 'title' => $art_title, 'content' => $art_content, 'chap_id' => $chap_id, 'lang' => $art_lang, 'next' => $art_next, 'prev' => $art_prev, 'art_number' => $art_number))) {
                    ...
                    SessionUtil::setVar('errormsg', __('Book import failed.') . $prev_error);
                    return false;
                }
            }
        }
    ...
    SessionUtil::setVar('statusmsg', __('Import succedeed'));

    //We now need to process the entire book, so send it along
    pnModAPIFunc('Book', 'admin', 'processalldocuments', array('book_id' => $book_id));
...
function book_admin_dolistbookfigures() {
    // Create output object - this object will store all of our output so that
    // we can return it easily when required
    $pnRender = pnRender::getInstance('Book', false);
    $pnRender->caching = false;
    ...
    if ($bookItems == 0) {
        //if we dont' have a book, then you
        //cannot have chapters
        return LogUtil::registerError(__('You have no books so you cannot list the figures'));
    }
    $pnRender->assign('books', $bookItems);

    return $pnRender->fetch('book_admin_dolistfigure.htm');
}

function book_admin_listbookfigures($args) {
    if (!SecurityUtil::checkPermission('Book::', "::", ACCESS_EDIT)) {
        return LogUtil::registerPermissionError();
    }
    ...
    // The user API function is called
    $figData = pnModAPIFunc('Book', 'user', 'getallfigures', array('book_id' => $book_id));

    if ($figData == false) {
        pnRedirect(pnModURL('Book', 'admin', 'dolistbookfigures'));
        return LogUtil::registerError(__('There are no figures to list'));
    }


    $pnRender->assign('figData', $figData);
    $ret_text = "";
    if ($button == 'listpaths') {
        $ret_text = $pnRender->fetch('book_admin_listpaths.htm');
    } else {
        $ret_text = $pnRender->fetch('book_admin_listigures.htm');
    }
    // Return the output that has been generated by this function
    return $ret_text;
}

function book_admin_modifyimagepaths($args) {
    ...
    foreach ($fig_ids as $fig_id) {
        ...
        $figure = pnModAPIFunc('Book', 'user', 'getfigure', array('fig_id' => $fig_id));

        $result = pnModAPIFunc('Book', 'admin', 'updatefigure',
                        array('fig_id' => $figure['fig_id'],
...
function book_admin_choose_verify_url() {
    $pnRender = pnRender::getInstance('Book', false);
    ...
    //get the complete list of books
    $books = pnModAPIFunc('Book', 'user', 'getall', array('startnum' => 1));

    if ($books == false) {
        //if we dont' have a book, then you
        //cannot have chapters
        return LogUtil::registerError(__('There are no URLS to check since you have not created a book.'));
    }
    ...
    foreach ($books as $book_item) {
        $book_id = $book_item['book_id'];
        //grab all the chapters for this book
        $chap_info = pnModAPIFunc('Book', 'user', 'getallchapters', array('book_id' => $book_id));
        //check to make sure they are legitimate. The function will
        //send back false if it fails
        $j++;
        if ($chap_info == false) {
    ...
    //there are no chapters to delete
    if ($j == $i) {
        return LogUtil::registerError(__('There are no chapters, so there are no URLS to check.'));
    }
    ...
    return $pnRender->fetch('book_admin_verify_chapter.htm');
}

function book_admin_verify_urls($args) {
    if (!SecurityUtil::checkPermission('Book::', "::", ACCESS_EDIT)) {
        return LogUtil::registerPermissionError();
    }
    if (!SecurityUtil::confirmAuthKey()) {
    ...
    $url_table = array();
    if (isset($chap_id)) {
        $chapter_info = pnModAPIFunc('Book', 'user', 'getchapter', array('chap_id' => $chap_id));
    ...
    $pnRender->assign('url_table', $url_table);

    return $pnRender->fetch('book_admin_verify_urls.htm');
}
...
function book_admin_checkstudentdefs() {
    //security check
    //only admins can do this
    ...
    $empty_defs = pnModAPIFunc('Book', 'admin', 'getemptyglossaryitems');
    ...
    $pnRender->assign('gloss_ids', DataUtil::formatForDisplayHTML(serialize($gloss_ids)));
    $pnRender->assign('empty_defs', $empty_defs);

    return $pnRender->fetch('book_admin_checkstudent_defs.htm');
}

function book_admin_modifyglossaryitems($args) {
    //only admins can do this
    if (!SecurityUtil::checkPermission('Book::', '::', ACCESS_ADD)) {
        LogUtil::registerPermissionError(pnModURL('Book', 'admin', 'view'));
        return true;
    ...
    foreach ($gloss_ids as $gloss_item) {
        ...
        if ($delete == "on") {
            if (!pnModAPIFunc('Book', 'admin', 'deleteglossary', array('gloss_id' => $gloss_item))) {
                LogUtil::registerError(__('Glossary deletion failed.'), null, pnModURL('Book', 'admin', 'checkstudentdefs'));
                return false;
            }
        } else {

            //we don't want to delete, we want to modify
            if (!pnModAPIFunc('Book', 'admin', 'updateglossary', array('gloss_id' => $gloss_item, 'term' => $term, 'definition' => $definition))) {
                LogUtil::registerError(__('Glossary modification failed.'), null, pnModURL('Book', 'admin', 'checkstudentdefs'));
                return false;
            }
        }
    }
    ...
    SessionUtil::setVar('statusmsg', __('Book glossary updated.'));
    pnRedirect(pnModURL('Book', 'admin', 'checkstudentdefs'));
    return true;
}

function book_admin_importglossaryitems($args) {
    if (!SecurityUtil::checkPermission('Book::', '::', ACCESS_ADD)) {
        return LogUtil::registerPermissionError(pnModURL('Book', 'admin', 'view'));
    }
    $pnRender = pnRender::getInstance('Book', false);

    return $pnRender->fetch('book_admin_importglossaryitems.htm');
}

function book_admin_doglossaryimport($args) {
    ...
    foreach ($matches[1] as $match_item) {
        ...
        pnModAPIFunc('Book', 'admin', 'createglossary', array('term' => $term, 'definition' => $def));
    }
    pnRedirect(pnModURL('Book', 'admin', 'view'));
    return true;
}
 ...
 * @return unknown_type
 */
function book_admin_dosearchreplace1() {
    ...
    return $pnRender->fetch('book_admin_dosearchreplace1.htm');
}

function book_admin_dosearchreplace2($args) {
    if (!SecurityUtil::checkPermission('Book::', "::", ACCESS_EDIT)) {
        return LogUtil::registerPermissionError();
    }
    if (!SecurityUtil::confirmAuthKey()) {
...
//grab the serach and replace information
    ...
    if ($chap_id == 0) {
        //do the whole book
        $preview_text = pnModAPIFunc('Book', 'admin', 'dosearchreplacebook', array('book_id' => $book_id,
                    'search_pat' => $search_pat,
                    'replace_pat' => $replace_pat,
                    'preview' => $preview === 'on'));
    } else {
        $preview_text = pnModAPIFunc('Book', 'admin', 'dosearchreplacechap', array('book_id' => $book_id,
                    'chap_id' => $chap_id,
                    'search_pat' => $search_pat,
                    'replace_pat' => $replace_pat,
                    'preview' => $preview === 'on'));
    ...
    if ($preview === 'on') {
        $render = pnRender::getInstance('Book', false);
        ...
        $chap_menus = _generate_chapter_menu($render);
...
function book_admin_listallimgfigpaths() {
