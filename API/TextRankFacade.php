...
use Paustian\BookModule\API\Tool\Graph;
use Paustian\BookModule\API\Tool\Parser;
use Paustian\BookModule\API\Tool\Score;
use Paustian\BookModule\API\Tool\StopWords\StopWordsAbstract;
 ...
 * </code>
 *
 * @package Paustian\BookModule\API
 */
class TextRankFacade
{
    /**
     ...
     *
     * @see \Paustian\BookModule\API\Tool\StopWords\English
     *
