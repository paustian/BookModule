{*  book_admin_dodeleteglossary.tpl,v 1.2 2005/08/30 19:29:32 paustian Exp  *}
{include file="book_admin_menu.tpl"}
<h2>{gt text="Delete Glossary Item"}</h2>
<form class="form" action="{pnmodurl modname="Book" type="admin" func="deleteglossary"}" method="post" enctype="application/x-www-form-urlencoded">
	...
	<p><input name="submit" type="submit" value="{gt text="Delete Glossary"}" /></p>
</form>
