...
<form class="form" action="{pnmodurl modname="Book" type="admin" func="updatechapter"}" method="post" enctype="application/x-www-form-urlencoded">
   ...
   <td>
    ...
    <td>
    		<input type="text" size="40" max="256" name="title_{$chaps[i].cid}" value="{$chaps[i].name|pnvarcensor}">
    	</td>
    <td>
    		<input type="text" size="5" max="5" name="number_{$chaps[i].cid}" value="{$chaps[i].number|pnvarcensor}">
    	</td>
    <td>
