...
class Book_Controller_Admin extends Zikula_AbstractController {
    ...
    public function newchapter() {
        ...
        $this->view->assign('bookmenu', $menu);

        return $this->view->fetch('book_admin_newchapter.tpl');
    }
...
//create the language list
        $this->view->assign('language', 'eng');


        // Return the output that has been generated by this function
        return $this->view->fetch('book_admin_newarticle.tpl');
    }
    ...
    public function modifychapter() {
        ...
        $this->view->assign('books', $books);
        $this->view->assign('chaps', $chapters);

        // Return the output that has been generated by this function
        return $this->view->fetch('book_admin_modifychapter.tpl');
    }
    ...
    public function modifyarticle1() {
        ...
        $this->view->assign('books', $book_string);

        return $this->view->fetch('book_admin_modifyarticle1.tpl');
    }
    ...
    private function _make_list($isForm = true, $access_level = ACCESS_EDIT) {
        ...
        foreach ($books as $book) {
            ...
            $chapters = ModUtil::apiFunc('Book', 'user', 'getallchapters', array('bid' => $book['bid']));
            ...
            $return_text .= $this->view->fetch('book_user_toc.tpl') . "\n";
            $chapter_data = array();
        }
...
// Confirm authorisation code.
        ...
        $this->view->assign('number', $article['number']);

        //we only need the book name
        $this->view->assign('book', $book['name']);
    ...
    public function modifyfigure1() {
        ...
        $this->view->assign('fig_list', $fig_menu);
        ...
        $this->view->assign('book_menu', $book_menu);

        // Return the output that has been generated by this function
        return $this->view->fetch('book_admin_modifyfigure1.tpl');
    }
    ...
    public function modifyfigure2() {
        ...
        if (isset($bid) && isset($chap_number) && isset($fig_number)) {
        ...
        $this->view->assign('fig_number', $figure['fig_number']);
        $this->view->assign('img_link', $figure['img_link']);
        $this->view->assign('fid', $figure['fid']);
        $this->view->assign('perm', $figure['perm']);
        $this->view->assign('chap_number', $figure['chap_number']);
        $this->view->assign('bid', $figure['bid']);


        $this->view->assign('books', $bookMenu);

        return $this->view->fetch('book_admin_modifyfigure2.tpl');
    }
...
// Confirm authorisation code.
    ...
    public function modifyglossary1() {
        ...
        $this->view->assign('term1', $term1);
        $this->view->assign('term2', $term2);
        $this->view->assign('term3', $term3);
        $this->view->assign('term4', $term4);
        $this->view->assign('last1', $last1);
        $this->view->assign('last2', $last2);
        $this->view->assign('last3', $last3);

        // Return the output that has been generated by this function
        return $this->view->fetch('book_admin_modifyglossary1.tpl');
    }
    ...
    public function modifyglossary2($args) {
        ...
        $this->view->assign('glossary', $glossData);

        // Return the output that has been generated by this function
        return $this->view->fetch('book_admin_modifyglossary2.tpl');
    }
    ...
    public function dodelete() {
        ...
        return $this->view->fetch('book_admin_dodelete.tpl');
    }
    ...
    public function chapterdisplay($args) {
        ...
        $chap_menus = $this->_generate_chapter_menu();
        //print_r($chap_menus);die;
        $this->view->assign('chapters', $chap_menus);

        return $this->view->fetch('book_admin_dochapterdelete.tpl');
    }
    ...
    public function dodeletearticle() {
        ...
        return $this->view->fetch('book_admin_doarticledelete.tpl');
    }
    ...
    public function dodeletefigure() {
        ...
        // Return the output that has been generated by this function
        return $this->view->fetch('book_admin_deletefigure.tpl');
    }
    ...
    public function dodeleteglossary() {
        ...
        // Return the output that has been generated by this function
        return $this->view->fetch('book_admin_dodeleteglossary.tpl');
    }
    ...
    public function menu() {
        ...
        // Start options menu
        $this->view->assign('title', $this->__('The Book Module'));
