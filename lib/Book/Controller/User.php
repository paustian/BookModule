...
class Book_Controller_User extends Zikula_AbstractController {
    ...
    public function main() {
       // Security check
        ...
        $this->view->assign('names', $bookTitleArray);

        return $this->view->fetch('book_user_main.tpl');
    }
...
// Please acknowledge use of this code by including this header.
    ...
    public function view($args) {
        ...
        // Display the entries
        $this->view->assign('titles', $chapter_titles);
        $this->view->assign('ids', $chapter_ids);
        $this->view->assign('number', $number);
        $this->view->assign('book', $book['name']);

        return $this->view->fetch('book_user_view.tpl');
    }
    ...
    public function display($args) {
        ...
        $this->view->assign('titles', $art_titles);
        $this->view->assign('ids', $aids);
        $this->view->assign('section_number', $section_num);
        if (SecurityUtil::checkPermission('Book::Chapter', "$bid::$chapter[cid]", ACCESS_READ)) {
            ...
            $render_output = $this->view->fetch('book_user_display.tpl');
        } else {
            //only allow access to the titles of the articles
            //and not links to them
            $render_output = $this->view->fetch('book_user_displayoverview.tpl');
        }
...
//you must have permission to read some book.
        ...
        return $this->view->fetch('book_user_displayglossary.tpl');
    }
...
//make sure that a glassary term is not already defined.
     ...
     *
     */
    public function collecthighlights($args) {
     ...
     */
    public function dohighlight($args) {
